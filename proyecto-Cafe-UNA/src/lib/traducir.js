...
const DICCIONARIO = {
  ...
  "Aquí puedes monitorear la actividad de Café UNA y gestionar la aplicación.":
    "Here you can monitor Café UNA activity and manage the application.",
  "Que tengas un gran día.": "Have a great day.",
  "Total de usuarios": "Total users",
  "Usuarios activos": "Active users",
  "Ingresos del mes": "Month revenue",
  "Ventas del día": "Today's sales",
  "Registrados en el sistema": "Registered in the system",
  "Con estado activo": "Currently active",
  "Suma de los 3 puntos de venta": "Sum of the 3 sales points",
  "Ingresos mensuales generales": "Overall monthly revenue",
  "Suma de los 3 puntos de venta (FUNDA-UNA, Bodega Central y Editorial).":
    "Sum of the 3 sales points (FUNDA-UNA, Central Warehouse and Editorial).",
  "Estado de usuarios": "User status",
  "Usuarios totales": "Total users",
  "Acceso rápido": "Quick access",
  "Gestionar módulos": "Manage modules",
  "Actividad reciente": "Recent activity",
  "No hay productos con stock crítico.": "There are no products with critical stock.",
  "No hay ventas registradas para este período.": "No sales recorded for this period.",
  "No hay actividades programadas.": "There are no scheduled activities.",
  "Cargando actividades...": "Loading activities...",
  "Productos que requieren atención.": "Products that need attention.",
  "Ver todos": "See all",
  "Ver todas": "See all",
  "Bajo mínimo": "Below minimum",
  ...
  "1. Tipo de voluntariado": "1. Type of volunteering",
  "2. Fechas disponibles": "2. Available dates",
  "3. Horario disponible": "3. Available schedule",
  ...
  "Sin fechas disponibles": "No available dates",
  ...
  "Revisá cada solicitud web, el cliente que la envió y el comprobante de pago antes de aceptar o rechazar.":
    "Review each web request, the customer who submitted it, and the payment receipt before accepting or rejecting.",
  "Ventas asociadas a este punto de venta, incluyendo compras web y presenciales.":
    "Sales linked to this point of sale, including web and in-person purchases.",
  "Comprobante de pago": "Payment receipt",
  "Cargando comprobante...": "Loading receipt...",
  "Tipo de cliente": "Customer type",
  "Persona jurídica": "Legal entity",
  "Persona física": "Individual",
  "Cédula jurídica": "Legal ID",
  "Representante legal": "Legal representative",
  "Disponible por punto de venta": "Available by point of sale",
  "Elegí dónde retirar o realizar tu compra. Solo se listan puntos con stock para todos los productos del carrito.":
    "Choose where to pick up or complete your purchase. Only locations with stock for every cart item are listed.",
  "Sin stock suficiente para este pedido": "Not enough stock for this order",
  "Arrastrá o seleccioná una imagen del comprobante": "Drag or select a receipt image",
  "JPG, PNG o WEBP. Máximo 10 MB.": "JPG, PNG, or WEBP. 10 MB max.",
  "Quitar imagen": "Remove image",
  "No hay puntos de venta disponibles en este momento.": "There are no points of sale available right now.",
  "Adjuntá el comprobante de pago.": "Attach the payment receipt.",
  "El punto de venta seleccionado no tiene stock suficiente para este pedido.":
    "The selected point of sale does not have enough stock for this order.",
  "Anterior": "Previous",
  "Siguiente": "Next",
  "Método": "Method",
  "Impuestos": "Taxes",
  ...
  "Podés pegar una URL o subir una imagen desde el dispositivo. JPG, PNG o WEBP. Máximo 10 MB.":
    "You can paste a URL or upload an image from your device. JPG, PNG or WEBP. 10 MB max.",
  "Arrastrá o seleccioná una imagen": "Drag or select an image",
  "Subiendo imagen...": "Uploading image...",
  "URL de la imagen": "Image URL",
  "Ver imagen completa": "View full image",
  "La imagen debe ser JPG, PNG o WEBP.": "The image must be JPG, PNG or WEBP.",
  "La imagen debe pesar máximo 10 MB.": "The image must be 10 MB or less.",
  "Seleccioná una imagen.": "Select an image.",
