    ...
    <AdminModal open onClose={onClose} maxWidth="max-w-xl" labelledBy="pos-stock-editor-title">
      ...
      <AdminModalBody>
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div className="border-t border-slate-100 pt-4"><AdminModalActions className="w-full justify-start" onCancel={onClose} primaryLabel={isSaving ? "Guardando..." : "Guardar stock"} primaryDisabled={isSaving} /></div>
        </form>
      </AdminModalBody>
    </AdminModal>
  );
